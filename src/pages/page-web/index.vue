  ...
  <div class="login-page">
    ...
    <div class="login-card">
      <div class="card-header">
        ...
        <h1 class="app-title">Drone Fleet Manager</h1>
        <p class="app-subtitle">Cloud API Control Platform</p>
      </div>
      <a-form
        :model="formState"
        class="login-form"
...
.logo-wrapper {
  ...
  height: 72px;
  margin: 0 auto 20px;
  background: linear-gradient(135deg, #2d8cf0 0%, #1a6dd4 100%);
  border-radius: 18px;
  display: flex;
  align-items: center;
  justify-content: center;
...
.login-btn {
  ...
  background: linear-gradient(135deg, #2d8cf0 0%, #1a6dd4 100%);
  border: none;
  box-shadow: 0 4px 14px rgba(45, 140, 240, 0.35);
  ...
  &:disabled {
    background: linear-gradient(135deg, #a0c4e8 0%, #8ab0d8 100%);
    box-shadow: none;
    transform: none;
  }
}
