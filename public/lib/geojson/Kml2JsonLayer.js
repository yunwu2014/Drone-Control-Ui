 ...
 */
if (window.mars3d && window.mars3d.layer && window.mars3d.layer.GeoJsonLayer) {
  console.log("GeoJsonLayer 已正确加载");
} else {
  console.error("GeoJsonLayer 未正确加载");
}
class Kml2JsonLayer extends window.mars3d.layer.GeoJsonLayer {
  /**
   * 加载新数据 或 刷新数据
   *
