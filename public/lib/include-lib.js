...
(function() {
  ...
  function load() {
    ...
    var libsConfig = {
      ...
      "font-marsgis": [libpath + "fonts/marsgis/iconfont.css"],
	  ...
	  webrtcstreamer: [
		  libpath + "webrtcstreamer/adapter.min.js",
		  libpath + "webrtcstreamer/webrtcstreamer.js",
	  ],
	  "kml-geojson": [
		libpath + "geojson/kml-geojson.js",
		libpath + "geojson/Kml2JsonLayer.js",
	  ]
    };
